...
| `name` | string | Yes | The display name for the section; becomes the text of the group's signs. |
| `networkId` | string | No | Network ID the room belongs to. Defaults to the current network. |
