...
<a name="invitations-api"></a>

## Invitations API

| Endpoint | Method | Description |
|-----|-----|-----|
| [social:inviteUsers](#invite-users-to-room) | websocket | Invite users to room |
| [social:deleteInvitation](#delete-invitation) | websocket | Delete invitation |
| [social:editInvitation](#edit-invitation) | websocket | Edit invitation |
| [social:acceptInvitation](#accept-invitation) | websocket | Accept invitation |
...
| [social:onInvitationCreated](#on-invitation-created-event) | websocketEvent | On invitation created event |
| [social:onInvitationEdited](#on-invitation-edited-event) | websocketEvent | On invitation edited event |
| [social:onInvitationDeleted](#on-invitation-deleted-event) | websocketEvent | On invitation deleted event |
| [room:permissionsChanged](#on-user-room-permissions-changed-event) | websocketEvent | On user room permissions changed event |

<br>

<a name="invite-users-to-room"></a>
...
Function creates user request of "Invitation" type. See [requests API](request.md) for further steps.
...
<pre>
{
    "data": {
        ...
        "inviteSilently": bool <span color="#1b1ef7"> // do not send invitation notification and email</span>
        "userIds": [ string ]
...
**Description:** Function creates user request of "Invitation" type, if owner permission granted. See [requests API](request.md) for further steps.
...
<a name="get-archived-user-invitations"></a>
...
{
    "data": {
        "invitations": [{ <a href="#invitation-info">invitation info structure</a> }]
    }
    "error": { "status": bool, "code": int, "message": string }
}
</pre>
...
<a name="request-thoughts-of-users"></a>
...
<a name="on-invitation-created-event"></a>
...
<a name="on-invitation-edited-event"></a>
...
<a name="on-invitation-deleted-event"></a>
...
<a name="on-user-room-permissions-changed-event"></a>
